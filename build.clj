;; Adapted from https://raw.githubusercontent.com/polyfy/polylith/v0.2.19/examples/doc-example/build.clj
;; Following instructions at https://cljdoc.org/d/polylith/clj-poly/0.2.19/doc/build
(ns build
  "The build script for the indicators-service adapted from the poly documentation.
